...
import { evaluateRisk } from '@/server/ads/google/googleAdsService';
import { z } from 'zod';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const validation = EvaluateRiskSchema.safeParse(body);
    ...
    const result = await evaluateRisk(tenantId, campaignId);
